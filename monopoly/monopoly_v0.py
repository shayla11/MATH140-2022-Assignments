...
max_spaces = 41 #total spaces on board
rolls = 10**6 #number of times to roll the dice
dice_sides = 4
...
for roll in range(rolls):
    ...
    if current_pos in [7,22,36]: # the chance spaces
        if ch_card == 0:
            ...
            if current_pos in range(1,5) or current_pos in range(35,41):
                current_pos = 5 # first railroad
            elif current_pos in range(5,15):
                current_pos = 15 # second railroad
            elif current_pos in range(15,25):
                current_pos = 25 # third railroad
            elif current_pos in range(25,35):
                current_pos = 35 # fourth railroad
        elif ch_card == 8: 
            if current_pos in range(28,41) or current_pos in range(1,12):
                current_pos = 12 #electric company
            elif current_pos in range(13,28):
